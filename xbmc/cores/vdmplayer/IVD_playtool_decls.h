...
public:
	...
	// wait for it.
	// CApplicationMessenger::GetInstance().SendMessage(msg, bWaitBeforeDone);
	...
	// CApplicationMessenger::GetInstance().SendMessage(msg, false);
	...
	// Inside this Kodi client should call "CApplicationMessenger::GetInstance().SendAction(CAction(ACTION_TRIGGER_OSD), WINDOW_INVALID, false);".
	virtual void OnActionTriggerOsd() = 0;

	//Kodi client should call CApplicationMessenger::GetInstance().SwitchToFullscreen() inside this method.
