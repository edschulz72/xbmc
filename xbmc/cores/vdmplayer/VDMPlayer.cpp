...
#if defined(TARGET_ANDROID) 
	CSettings::GetInstance().SetString("audiooutput.audiodevice", "NULL:NULL");
#endif
...
#if defined(TARGET_ANDROID) 
   CSettings::GetInstance().SetString("audiooutput.audiodevice", "AUDIOTRACK:android,audiotrack");
#endif
	...
	if (CSettings::GetInstance().GetBool("videoplayer.quitstereomodeonstop") && CSettings::GetInstance().GetInt("videoscreen.stereoscopicmode") != RENDER_STEREO_MODE_OFF)
	{
...
void CVDMPlayer::UpdateWindowSize(void)
{
	...
	int nx = CDisplaySettings::GetInstance().GetResolutionInfo(res).iWidth;
	int ny = CDisplaySettings::GetInstance().GetResolutionInfo(res).iHeight;
...
{
	CLog::Log(LOGNOTICE, "******CVDMPlayer::OpenFile CurrentVideoSettings AudioStream = %d", CMediaSettings::GetInstance().GetCurrentVideoSettings().m_AudioStream);
	CLog::Log(LOGNOTICE, "******CVDMPlayer::OpenFile CurrentVideoSettings SubtitleStream = %d", CMediaSettings::GetInstance().GetCurrentVideoSettings().m_SubtitleStream);
	CLog::Log(LOGNOTICE, "******CVDMPlayer::OpenFile CurrentVideoSettings SubtitleDelay = %.4f", CMediaSettings::GetInstance().GetCurrentVideoSettings().m_SubtitleDelay);
	CLog::Log(LOGNOTICE, "******CVDMPlayer::OpenFile CurrentVideoSettings SubtitleOn = %d", CMediaSettings::GetInstance().GetCurrentVideoSettings().m_SubtitleOn);
	CLog::Log(LOGNOTICE, "******CVDMPlayer::OpenFile CurrentVideoSettings SubtitleDelay = %.4f", CMediaSettings::GetInstance().GetCurrentVideoSettings().m_SubtitleDelay);

	if (!StringUtils::EqualsNoCase(CSettings::GetInstance().GetString("locale.audiolanguage"), "original") &&
	...
	{
		SetAudioStream(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_AudioStream);
	}

	if (!StringUtils::EqualsNoCase(CSettings::GetInstance().GetString("locale.subtitlelanguage"), "original") &&
	...
	{
		SetSubtitle(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_SubtitleStream);
	}
	...
	SetSubtitleWhetherOverAssOrig(CSettings::GetInstance().GetBool("subtitles.overrideassfonts"));
	SetSubttileFeatures();
...
bool CVDMPlayer::InitPlayCore(void)
{
	...
	m_pConfig->SetFontName(CSettings::GetInstance().GetString("subtitles.font").c_str());
...
{	
	...
	m_pPlayToolConfig->SetEGLContext(g_Windowing.GetEGLContext());
#endif
	SetCSettings("window.width", CSettings::GetInstance().GetInt("window.width"));
	SetCSettings("window.height", CSettings::GetInstance().GetInt("window.height"));

	// videoplayer
	std::string strAudioLanguage = CSettings::GetInstance().GetString("locale.audiolanguage");
	...
	SetCSettings("videoplayer.preferdefaultflag", CSettings::GetInstance().GetBool("videoplayer.preferdefaultflag"));
	SetCSettings("videoplayer.autoplaynextitem", CSettings::GetInstance().GetBool("videoplayer.autoplaynextitem"));
	SetCSettings("videoplayer.seeksteps", CSettings::GetInstance().GetInt("videoplayer.seeksteps"));
	SetCSettings("videoplayer.seekdelay", CSettings::GetInstance().GetInt("videoplayer.seekdelay"));
	SetCSettings("videoplayer.adjustrefreshrate", CSettings::GetInstance().GetInt("videoplayer.adjustrefreshrate"));
	SetCSettings("videoplayer.pauseafterrefreshchange", CSettings::GetInstance().GetInt("videoplayer.pauseafterrefreshchange"));
	SetCSettings("videoplayer.usedisplayasclock", CSettings::GetInstance().GetBool("videoplayer.usedisplayasclock"));
	SetCSettings("videoplayer.errorinaspect", CSettings::GetInstance().GetInt("videoplayer.errorinaspect"));
	SetCSettings("videoplayer.stretch43", CSettings::GetInstance().GetInt("videoplayer.stretch43"));
	SetCSettings("videoplayer.teletextenabled", CSettings::GetInstance().GetBool("videoplayer.teletextenabled"));
	SetCSettings("videoplayer.teletextscale", CSettings::GetInstance().GetBool("videoplayer.teletextscale"));
	SetCSettings("videoplayer.stereoscopicplaybackmode", CSettings::GetInstance().GetInt("videoplayer.stereoscopicplaybackmode"));
	SetCSettings("videoplayer.quitstereomodeonstop", CSettings::GetInstance().GetBool("videoplayer.quitstereomodeonstop"));

	// videoacceleration
	SetCSettings("videoplayer.rendermethod", CSettings::GetInstance().GetInt("videoplayer.rendermethod"));
	SetCSettings("videoplayer.hqscalers", CSettings::GetInstance().GetInt("videoplayer.hqscalers"));
	SetCSettings("videoplayer.useamcodec", CSettings::GetInstance().GetBool("videoplayer.useamcodec"));
	SetCSettings("videoplayer.useawcodec", CSettings::GetInstance().GetBool("videoplayer.useawcodec"));
	SetCSettings("videoplayer.userkcodec", CSettings::GetInstance().GetBool("videoplayer.userkcodec"));
	SetCSettings("videoplayer.usea31codec", CSettings::GetInstance().GetBool("videoplayer.usea31codec"));
	SetCSettings("videoplayer.usehisicodec", CSettings::GetInstance().GetBool("videoplayer.usehisicodec"));
	SetCSettings("videoplayer.usevdpau", CSettings::GetInstance().GetBool("videoplayer.usevdpau"));
	SetCSettings("videoplayer.usevdpaumixer", CSettings::GetInstance().GetBool("videoplayer.usevdpaumixer"));
	SetCSettings("videoplayer.usevdpaumpeg2", CSettings::GetInstance().GetBool("videoplayer.usevdpaumpeg2"));
	SetCSettings("videoplayer.usevdpaumpeg4", CSettings::GetInstance().GetBool("videoplayer.usevdpaumpeg4"));
	SetCSettings("videoplayer.usevdpauvc1", CSettings::GetInstance().GetBool("videoplayer.usevdpauvc1"));
	SetCSettings("videoplayer.usevaapi", CSettings::GetInstance().GetBool("videoplayer.usevaapi"));
	SetCSettings("videoplayer.usevaapimpeg2", CSettings::GetInstance().GetBool("videoplayer.usevaapimpeg2"));
	SetCSettings("videoplayer.usevaapimpeg4", CSettings::GetInstance().GetBool("videoplayer.usevaapimpeg4"));
	SetCSettings("videoplayer.usevaapivc1", CSettings::GetInstance().GetBool("videoplayer.usevaapivc1"));
	SetCSettings("videoplayer.prefervaapirender", CSettings::GetInstance().GetBool("videoplayer.prefervaapirender"));
	SetCSettings("videoplayer.usedxva2", CSettings::GetInstance().GetBool("videoplayer.usedxva2"));
	SetCSettings("videoplayer.useomxplayer", CSettings::GetInstance().GetBool("videoplayer.useomxplayer"));
	SetCSettings("videoplayer.useomx", CSettings::GetInstance().GetBool("videoplayer.useomx"));
	SetCSettings("videoplayer.usevideotoolbox", CSettings::GetInstance().GetBool("videoplayer.usevideotoolbox"));
	SetCSettings("videoplayer.usevda", CSettings::GetInstance().GetBool("videoplayer.usevda"));
	SetCSettings("videoplayer.usemediacodec", CSettings::GetInstance().GetBool("videoplayer.usemediacodec"));
	SetCSettings("videoplayer.usestagefright", CSettings::GetInstance().GetBool("videoplayer.usestagefright"));

	// subtitles
	std::string strSubtitleLanguage = CSettings::GetInstance().GetString("locale.subtitlelanguage");
	...
	SetCSettings("subtitles.parsecaptions", CSettings::GetInstance().GetBool("subtitles.parsecaptions"));
	SetCSettings("subtitles.align", CSettings::GetInstance().GetInt("subtitles.align"));
	SetCSettings("subtitles.stereoscopicdepth", CSettings::GetInstance().GetInt("subtitles.stereoscopicdepth"));
	SetCSettings("subtitles.font", CSettings::GetInstance().GetString("subtitles.font").c_str());
	SetCSettings("subtitles.height", CSettings::GetInstance().GetInt("subtitles.height"));
	SetCSettings("subtitles.style", CSettings::GetInstance().GetInt("subtitles.style"));
	SetCSettings("subtitles.color", CSettings::GetInstance().GetInt("subtitles.color"));
	SetCSettings("subtitles.charset", CSettings::GetInstance().GetString("subtitles.charset").c_str());
	SetCSettings("subtitles.languages", CSettings::GetInstance().GetString("subtitles.languages").c_str());
	SetCSettings("subtitles.storagemode", CSettings::GetInstance().GetInt("subtitles.storagemode"));
	SetCSettings("subtitles.custompath", CSettings::GetInstance().GetString("subtitles.custompath").c_str());
	SetCSettings("subtitles.pauseonsearch", CSettings::GetInstance().GetBool("subtitles.pauseonsearch"));
	SetCSettings("subtitles.downloadfirst", CSettings::GetInstance().GetBool("subtitles.downloadfirst"));

	// dvds
	SetCSettings("dvds.autorun", CSettings::GetInstance().GetBool("dvds.autorun"));
	SetCSettings("dvds.playerregion", CSettings::GetInstance().GetInt("dvds.playerregion"));
	SetCSettings("dvds.automenu", CSettings::GetInstance().GetBool("dvds.automenu"));
	SetCSettings("disc.playback", CSettings::GetInstance().GetInt("disc.playback"));

	// videoscreen
	SetCSettings("videoscreen.monitor", CSettings::GetInstance().GetString("videoscreen.monitor").c_str());
	SetCSettings("videoscreen.screen", CSettings::GetInstance().GetInt("videoscreen.screen"));
	SetCSettings("videoscreen.resolution", CSettings::GetInstance().GetInt("videoscreen.resolution"));
	SetCSettings("videoscreen.screenmode", CSettings::GetInstance().GetString("videoscreen.screenmode").c_str());
	SetCSettings("videoscreen.fakefullscreen", CSettings::GetInstance().GetBool("videoscreen.fakefullscreen"));
	SetCSettings("videoscreen.blankdisplays", CSettings::GetInstance().GetBool("videoscreen.blankdisplays"));
	SetCSettings("videoscreen.stereoscopicmode", CSettings::GetInstance().GetInt("videoscreen.stereoscopicmode"));
	SetCSettings("videoscreen.preferedstereoscopicmode", CSettings::GetInstance().GetInt("videoscreen.preferedstereoscopicmode"));
	SetCSettings("videoscreen.vsync", CSettings::GetInstance().GetInt("videoscreen.vsync"));
	SetCSettings("videoscreen.limitedrange", CSettings::GetInstance().GetBool("videoscreen.limitedrange"));

	// audio output
	SetCSettings("audiooutput.audiodevice", CSettings::GetInstance().GetString("audiooutput.audiodevice").c_str());
	SetCSettings("audiooutput.channels", CSettings::GetInstance().GetInt("audiooutput.channels"));
	SetCSettings("audiooutput.config", CSettings::GetInstance().GetInt("audiooutput.config"));
	SetCSettings("audiooutput.samplerate", CSettings::GetInstance().GetInt("audiooutput.samplerate"));
	SetCSettings("audiooutput.stereoupmix", CSettings::GetInstance().GetBool("audiooutput.stereoupmix"));
	SetCSettings("audiooutput.maintainoriginalvolume", CSettings::GetInstance().GetBool("audiooutput.maintainoriginalvolume"));
	SetCSettings("audiooutput.processquality", CSettings::GetInstance().GetInt("audiooutput.processquality"));
	SetCSettings("audiooutput.streamsilence", CSettings::GetInstance().GetInt("audiooutput.streamsilence"));
	SetCSettings("audiooutput.guisoundmode", CSettings::GetInstance().GetInt("audiooutput.guisoundmode"));
	SetCSettings("audiooutput.passthrough", CSettings::GetInstance().GetBool("audiooutput.passthrough"));
	SetCSettings("audiooutput.passthroughdevice", CSettings::GetInstance().GetString("audiooutput.passthroughdevice").c_str());
	SetCSettings("audiooutput.ac3passthrough", CSettings::GetInstance().GetBool("audiooutput.ac3passthrough"));
	SetCSettings("audiooutput.ac3transcode", CSettings::GetInstance().GetBool("audiooutput.ac3transcode"));
	SetCSettings("audiooutput.eac3passthrough", CSettings::GetInstance().GetBool("audiooutput.eac3passthrough"));
	SetCSettings("audiooutput.dtspassthrough", CSettings::GetInstance().GetBool("audiooutput.dtspassthrough"));
	SetCSettings("audiooutput.truehdpassthrough", CSettings::GetInstance().GetBool("audiooutput.truehdpassthrough"));
	SetCSettings("audiooutput.dtshdpassthrough", CSettings::GetInstance().GetBool("audiooutput.dtshdpassthrough"));
	...
	*/
	...
	SetDeinterlaceMode(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_DeinterlaceMode);
	SetInterlaceMethod(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_InterlaceMethod);
	SetScalingMethod(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_ScalingMethod);
	SetViewMode((ViewMode)CMediaSettings::GetInstance().GetCurrentVideoSettings().m_ViewMode);
	SetCustomZoomAmount(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_CustomZoomAmount);
	SetCustomPixelRatio(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_CustomPixelRatio);
	SetCustomVerticalShift(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_CustomVerticalShift);
	SetCustomNonLinStretch(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_CustomNonLinStretch);
	SetDynamicRangeCompression(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_VolumeAmplification * 100);
	SetBrightness(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_Brightness);
	SetContrast(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_Contrast);
	SetVdpauNoiseRedution(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_NoiseReduction);
	SetPostProcessOn(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_PostProcess);
	SetAVDelay(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_AudioDelay);
	SetStereoMode((RENDER_STEREO_MODE)CMediaSettings::GetInstance().GetCurrentVideoSettings().m_StereoMode);
	SetStereoInvert(CMediaSettings::GetInstance().GetCurrentVideoSettings().m_StereoInvert);

	SetPlayMode((DIMENSIONMODE)CSettings::GetInstance().GetInt("d3.mode"));
...
void CVDMPlayer::SetSubttileFeatures(void)
{
	...
	SetSubtitlePos((SubtitleAlign)CSettings::GetInstance().GetInt("subtitles.align"), 0);
	SetSubColor(CSettings::GetInstance().GetInt("subtitles.color"));
	SetSubtitleSize(CSettings::GetInstance().GetInt("subtitles.height"));
	SetSubtitleStyle(CSettings::GetInstance().GetInt("subtitles.style"));

	switch (CSettings::GetInstance().GetInt("subtitles.style"))
	{
	case 0:
	{
