...
void CCurlFile::SetRequestFormData(const CStdString& name, const CStdString& data)
{
	m_requestformdatalist[name] = data;
}

void CCurlFile::SetRequestFormFile(const CStdString& name, const CStdString& file)
{
