...
public:
  ...
  virtual const char* Vidon_GetAddonsInfo( const char* params ) = 0;

  virtual const char* Vidon_GetVendorName() = 0;
...
class DLLVidonUtils:public DllDynamic, DLLVidonUtilsInterface
{
  ...
  DEFINE_METHOD1( const char*, Vidon_GetAddonsInfo, ( const char* p1 ) )

  DEFINE_METHOD0(const char*, Vidon_GetVendorName)
  ...
  RESOLVE_METHOD(Vidon_GetAddonsInfo)

  RESOLVE_METHOD(Vidon_GetVendorName)
